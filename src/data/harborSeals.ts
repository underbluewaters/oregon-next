...
npx tiny-geoprocessing-recipes \
  'data/src/BIO_Pacific_Harbor_Seal_Haulouts_ODFW_2011.fgb' \
  'src/data/harborSeals.ts' \
...
export interface BIO_Pacific_Harbor_Seal_Haulouts_ODFW_2011 {
  Location: string;
}


const featureData: BIO_Pacific_Harbor_Seal_Haulouts_ODFW_2011[] = [
  {
 ...
 * @param maxX 
 * @param maxY 
* @returns BIO_Pacific_Harbor_Seal_Haulouts_ODFW_2011[]
 */
function search(minX: number, minY: number, maxX: number, maxY: number): BIO_Pacific_Harbor_Seal_Haulouts_ODFW_2011[] {
...
* @returns BIO_Pacific_Harbor_Seal_Haulouts_ODFW_2011[]
 */
function neighbors(x: number,y: number, maxResults?: number, maxDistance?: number): BIO_Pacific_Harbor_Seal_Haulouts_ODFW_2011[] {
 ...
 * @returns BIO_Pacific_Harbor_Seal_Haulouts_ODFW_2011[]
 */ 
function intersects(feature: Feature<Polygon | MultiPolygon>): BIO_Pacific_Harbor_Seal_Haulouts_ODFW_2011[] {
