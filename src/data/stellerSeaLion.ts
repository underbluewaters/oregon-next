...
npx tiny-geoprocessing-recipes \
  'data/src/BIO_Steller_Sea_Lion_Haulouts_ODFW_2011.fgb' \
  'src/data/stellerSeaLion.ts' \
...
export interface BIO_Steller_Sea_Lion_Haulouts_ODFW_2011 {
  Location: string;
}


const featureData: BIO_Steller_Sea_Lion_Haulouts_ODFW_2011[] = [
  {
 ...
 * @param maxX 
 * @param maxY 
* @returns BIO_Steller_Sea_Lion_Haulouts_ODFW_2011[]
 */
function search(minX: number, minY: number, maxX: number, maxY: number): BIO_Steller_Sea_Lion_Haulouts_ODFW_2011[] {
...
* @returns BIO_Steller_Sea_Lion_Haulouts_ODFW_2011[]
 */
function neighbors(x: number,y: number, maxResults?: number, maxDistance?: number): BIO_Steller_Sea_Lion_Haulouts_ODFW_2011[] {
 ...
 * @returns BIO_Steller_Sea_Lion_Haulouts_ODFW_2011[]
 */ 
function intersects(feature: Feature<Polygon | MultiPolygon>): BIO_Steller_Sea_Lion_Haulouts_ODFW_2011[] {
